...
public class Task_1 {
    public static void main(String[] args) {
        Cat cat1 = new Cat();
        cat1.setId(1);
        cat1.setNameCat("Кузя");
        cat1.setColorCat("Барсик");
        cat1.setAgeCat(3);
        ...
        cat2.setColorCat("Люська");
        cat2.setAgeCat(3);
        System.out.println(cat2);

        Cat cat3 = new Cat();
        cat3.setId(1);
        cat3.setNameCat("Кузя");
        cat3.setColorCat("Барсик");
        cat3.setAgeCat(3);
        System.out.println(cat3);

        Cat cat4 = new Cat();
        cat4.setId(1);
        cat4.setNameCat("Кузя");
        cat4.setColorCat("Барсик");
        cat4.setAgeCat(3);
